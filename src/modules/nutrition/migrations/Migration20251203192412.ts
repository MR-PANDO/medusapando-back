...
export class Migration20251203192412 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table if exists "product_nutrition" drop constraint if exists "product_nutrition_product_id_unique";`);
