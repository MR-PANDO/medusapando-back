...
/**
 * Complete list of Colombian departments and their municipalities.
 * Source: DANE - DIVIPOLA (División Político-Administrativa de Colombia)
 * 32 departments + 1 Distrito Capital = 33 entries
 * ~1,122 municipalities total
 *
 * For Bogotá D.C., localidades are listed instead of municipalities
 * since they are more useful for delivery/shipping purposes.
 */
const DEPARTMENTS_DATA: Record<string, string[]> = {
  "Amazonas": [
    "Leticia", "Puerto Nariño",
    // Corregimientos departamentales (áreas no municipalizadas)
    "El Encanto", "La Chorrera", "La Pedrera", "La Victoria",
    "Mirití-Paraná", "Puerto Alegría", "Puerto Arica",
    "Puerto Santander", "Tarapacá",
  ],
  "Antioquia": [
    "Medellín", "Abejorral", "Abriaquí", "Alejandría", "Amagá", "Amalfi",
    "Andes", "Angelópolis", "Angostura", "Anorí", "Santa Fé de Antioquia",
    ...
    "Caucasia", "Chigorodó", "Cisneros", "Cocorná", "Concepción", "Concordia",
    "Copacabana", "Dabeiba", "Donmatías", "Ebéjico", "El Bagre", "Entrerríos",
    ...
    "La Pintada", "La Unión", "Liborina", "Maceo", "Marinilla", "Montebello",
  ...
  "Bolívar": [
    ...
    "Córdoba", "Clemencia", "El Carmen de Bolívar", "El Guamo", "El Peñón",
    "Hatillo de Loba", "Magangué", "Mahates", "Margarita", "María la Baja",
    "Montecristo", "Santa Cruz de Mompox", "Morales", "Norosí", "Pinillos",
  ...
  "Boyacá": [
    ...
    "Corrales", "Covarachía", "Cubará", "Cucaita", "Cuítiva", "Chíquiza",
    "Chivor", "Duitama", "El Cocuy", "El Espino", "Firavitoba", "Floresta",
    "Gachantivá", "Gámeza", "Garagoa", "Guacamayas", "Guateque", "Guayatá",
    "Güicán de la Sierra", "Iza", "Jenesano", "Jericó", "Labranzagrande",
    "La Capilla", "La Victoria", "La Uvita", "Villa de Leyva", "Macanal",
    "Maripí", "Miraflores", "Mongua", "Monguí", "Moniquirá", "Motavita",
    ...
    "Santa Sofía", "Sativanorte", "Sativasur", "Siachoque", "Soatá", "Socotá",
    "Socha", "Sogamoso", "Somondoco", "Sora", "Sotaquirá", "Soracá", "Susacón",
    "Sutamarchán", "Sutatenza", "Tasco", "Tenza", "Tibaná", "Tibasosa",
    "Tinjacá", "Tipacoque", "Toca", "Togüí", "Tópaga", "Tota", "Tununguá",
  ...
  "Cesar": [
    ...
    "Río de Oro", "La Paz", "San Alberto", "San Diego", "San Martín",
    "Tamalameque",
  ],
  "Chocó": [
  ...
  "Córdoba": [
    ...
    "Puerto Escondido", "Puerto Libertador", "Purísima de la Concepción",
  ...
  "Cundinamarca": [
    ...
    "Machetá", "Madrid", "Manta", "Medina", "Mosquera", "Nariño", "Nemocón",
    "Nilo", "Nimaima", "Nocaima", "Venecia", "Pacho", "Paime", "Pandi",
    "Paratebueno", "Pasca", "Puerto Salgar", "Pulí", "Quebradanegra", "Quetame",
    "Quipile", "Apulo", "Ricaurte", "San Antonio del Tequendama", "San Bernardo",
    ...
    "Ubalá", "Ubaque", "Villa de San Diego de Ubaté", "Une", "Útica", "Vergara",
    "Vianí", "Villagómez", "Villapinzón", "Villeta", "Viotá", "Yacopí",
    "Zipacón", "Zipaquirá",
  ],
  "Guainía": [
  ...
  "Meta": [
    ...
    "El Dorado", "Fuente de Oro", "Granada", "Guamal", "Mapiripán", "Mesetas",
    "La Macarena", "Uribe", "Lejanías", "Puerto Concordia", "Puerto Gaitán",
  ...
  "Nariño": [
    ...
    "San Andrés de Tumaco", "Túquerres", "Yacuanquer",
  ],
  "Norte de Santander": [
    "San José de Cúcuta", "Ábrego", "Arboledas", "Bochalema", "Bucarasica",
    "Cácota", "Cáchira", "Chinácota", "Chitagá", "Convención", "Cucutilla",
    "Durania", "El Carmen", "El Tarra", "El Zulia", "Gramalote", "Hacarí",
    "Herrán", "Labateca", "La Esperanza", "La Playa", "Los Patios", "Lourdes",
  ...
  "Putumayo": [
    ...
    "Puerto Guzmán", "Puerto Leguízamo", "Sibundoy", "San Francisco",
  ...
  "Santander": [
    ...
    "Capitanejo", "Carcasí", "Cepitá", "Cerrito", "Charalá", "Charta", "Chima",
    ...
    "Hato", "Jesús María", "Jordán", "La Belleza", "Landázuri", "La Paz",
    ...
    "San Gil", "San Joaquín", "San José de Miranda", "San Miguel",
  ...
  "Sucre": [
    ...
    "San Luis de Sincé", "Sucre", "Santiago de Tolú", "San José de Toluviejo",
  ],
  "Tolima": [
    ...
    "San Sebastián de Mariquita", "Melgar", "Murillo", "Natagaima", "Ortega",
...
export default async function seedLocations({ container }: ExecArgs) {
  const locationService: LocationModuleService = container.resolve(LOCATION_MODULE)

  // Check if already seeded
  const [existing] = await locationService.listAndCountDepartments({}, { take: 1 })
  if (existing.length > 0) {
    console.log("Locations already seeded, skipping...")
    return
  }

  console.log("Seeding Colombian locations...")

  // Track all municipality slugs globally to handle duplicates
  const usedSlugs = new Set<string>()
  let totalMunicipalities = 0
  let totalDepartments = 0

  for (const [deptName, municipalities] of Object.entries(DEPARTMENTS_DATA)) {
    const deptSlug = toSlug(deptName)

    const department = await locationService.createDepartments({
      name: deptName,
      slug: deptSlug,
    })
    totalDepartments++

    const municipalityRecords = municipalities.map((name) => {
      let slug = toSlug(name)
      // Handle duplicate slugs by appending department slug
      if (usedSlugs.has(slug)) {
        slug = `${slug}-${deptSlug}`
      }
      usedSlugs.add(slug)
      return { name, slug, department_id: department.id }
    })

    await locationService.createMunicipalities(municipalityRecords)
    totalMunicipalities += municipalityRecords.length
    console.log(`  ✓ ${deptName}: ${municipalityRecords.length} municipalities`)
  }

  console.log(
    `\nDone! ${totalDepartments} departments, ${totalMunicipalities} municipalities total.`
  )
}
